...
'           End If
'   			If KeyDown(KEY_LEFT)
'               Self.playfield.CameraX=Self.playfield.CameraX-10
'               sprite1.PositionX = sprite1.PositionX-10
'               
'           End If
'       
...
'       
'           If KeyDown(KEY_UP)
'               Self.playfield.CameraY=Self.playfield.CameraY-10
'               sprite1.PositionY = sprite1.PositionY-10
'           End If
'       
'           If KeyDown(KEY_DOWN)
'               Self.playfield.CameraY=Self.playfield.CameraY+10
