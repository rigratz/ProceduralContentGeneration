...
c_Game.m_new=function(){
	push_err();
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/main.monkey<7>";
...
c_Game.prototype.p_OnCreate=function(){
	push_err();
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/main.monkey<12>";
	var t_img=bb_graphics_LoadImage2("char_walk_down.png",69,102,4,c_Image.m_DefaultFlags);
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/main.monkey<13>";
	this.m_p1=c_Player.m_new.call(new c_Player,t_img,100,100);
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/main.monkey<14>";
	this.m_music=bb_audio_LoadSound("tetris.mp3");
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/main.monkey<15>";
	print(String(bb_audio_MusicState()));
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/main.monkey<16>";
	bb_audio_PlayMusic("tetris.mp3",1);
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/main.monkey<17>";
	print(String(bb_audio_MusicState()));
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/main.monkey<18>";
...
c_Game.prototype.p_OnUpdate=function(){
	push_err();
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/main.monkey<22>";
	this.m_p1.p_Update();
	pop_err();
	return 0;
}
c_Game.prototype.p_OnRender=function(){
	push_err();
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/main.monkey<26>";
	bb_graphics_Cls(255.0,255.0,255.0);
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/main.monkey<27>";
	this.m_p1.p_Draw();
	pop_err();
	return 0;
}
...
function bbMain(){
	push_err();
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/main.monkey<40>";
...
c_Player.m_new=function(t_i,t_x,t_y){
	push_err();
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<14>";
	dbg_object(this).m_image=t_i;
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<15>";
	dbg_object(this).m_x=t_x;
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<16>";
	dbg_object(this).m_y=t_y;
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<17>";
	dbg_object(this).m_xVel=0;
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<18>";
	dbg_object(this).m_yVel=0;
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<19>";
...
c_Player.m_new2=function(){
	push_err();
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<4>";
	pop_err();
	return this;
}
c_Player.prototype.p_Update=function(){
	push_err();
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<23>";
	if((bb_input_KeyDown(37))!=0){
		err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<24>";
		this.m_x=this.m_x-2;
	}
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<26>";
	if((bb_input_KeyDown(39))!=0){
		err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<27>";
		this.m_x=this.m_x+2;
	}
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<29>";
	if((bb_input_KeyDown(40))!=0){
		err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<30>";
		this.m_y=this.m_y+2;
	}
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<32>";
	if((bb_input_KeyDown(38))!=0){
		err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<33>";
		this.m_y=this.m_y-2;
	}
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<36>";
...
c_Player.prototype.p_Draw=function(){
	push_err();
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/player.monkey<40>";
...
c_Animation.m_new=function(t_i,t_f,t_w,t_h,t_ft){
	push_err();
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/animation.monkey<15>";
	dbg_object(this).m_img=t_i;
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/animation.monkey<16>";
	dbg_object(this).m_frames=t_f;
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/animation.monkey<17>";
	dbg_object(this).m_width=t_w;
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/animation.monkey<18>";
	dbg_object(this).m_height=t_h;
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/animation.monkey<19>";
	dbg_object(this).m_frameTime=t_ft;
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/animation.monkey<21>";
	dbg_object(this).m_elapsed=0;
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/animation.monkey<22>";
	dbg_object(this).m_frame=0;
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/animation.monkey<23>";
...
c_Animation.m_new2=function(){
	push_err();
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/animation.monkey<4>";
	pop_err();
	return this;
}
c_Animation.prototype.p_getFrame=function(){
	push_err();
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/animation.monkey<27>";
	this.m_elapsed=this.m_elapsed+(bb_app_Millisecs()-this.m_lastTime);
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/animation.monkey<28>";
	this.m_lastTime=bb_app_Millisecs();
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/animation.monkey<30>";
	var t_toReturn=((Math.floor((this.m_elapsed/this.m_frameTime)|0))|0);
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/animation.monkey<32>";
	if(t_toReturn>this.m_frames-1){
		err_info="/Applications/MonkeyXFree84f/MonkeyTest/animation.monkey<33>";
		t_toReturn=0;
		err_info="/Applications/MonkeyXFree84f/MonkeyTest/animation.monkey<34>";
		this.m_elapsed=0;
	}
	err_info="/Applications/MonkeyXFree84f/MonkeyTest/animation.monkey<37>";
	pop_err();
	return t_toReturn;
}
function c_Sound(){
